...
summary: In this study, we propose a supervised machine learning ensemble strategy, known as 'PiggyCast', trained on top of these forecast datasets (a method known as “stacking”) to predict ERA5 variables, thereby exploiting the strengths of each base model and aiming to outperform forecasts from any base model alone.
